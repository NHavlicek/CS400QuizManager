...
/**
 * Filename: HomeScreenGUI.java Project: A-Team Quiz Application Team: A-Team 27
...
public class HomeScreenGUI extends BorderPane {
	...
	public HomeScreenGUI(Main main, Stage primaryStage) {
		...
		homeScreenOptions.getChildren().addAll(homescreenExit, homescreenSave, homescreenLoad, addQuestion);
